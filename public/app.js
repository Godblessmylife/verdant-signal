(function () {
  ...
  function bindShell() {
    ...
    document.querySelectorAll('[data-auth-action]').forEach((button) => button.addEventListener('click', () => { state.guestMode = false; state.player = null; state.message = ''; renderAuth(); }));
